...
class FR_OT_OAM_Trim_Selected(bpy.types.Operator):
    bl_idname = "fr_oam.trim_selected"
    bl_label = "Trim Selected"
    bl_description = "Trim Selected"
        ...
        if obj is not None:
            ...
            for index, slot in enumerate(action_list):
                ...
                if slot.select:
                    ...
                    action_list_helper.set_active_index(index)
...
classes = [FR_OT_OAM_Trim_Selected]
