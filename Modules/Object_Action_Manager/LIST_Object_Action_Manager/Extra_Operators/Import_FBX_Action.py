...
class FR_OT_OAM_Import_FBX_Action(bpy.types.Operator, bpy_extras.io_utils.ImportHelper):
    """Import FBX Action"""
    bl_idname = "fr_oam.import_fbx_action"
    bl_label = "Add FBX Action to Slot (Experimental)"
...
classes = [FR_OT_OAM_Import_FBX_Action]
