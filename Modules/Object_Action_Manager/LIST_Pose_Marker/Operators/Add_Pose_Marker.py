...
class FR_OT_PMM_Add_Pose_Marker(bpy.types.Operator):

    bl_idname = "fr_pmm.add_pose_marker"
    bl_label = "Add Pose Marker to Action"
    bl_description = "Add a new Pose Marker to Action"
    ...
    def execute(self, context):
        ...
        if action is not None:
            Pose_Marker_Functions.add_pose_marker(action, name=self.name, frame=self.frame)
...
classes = [FR_OT_PMM_Add_Pose_Marker]
