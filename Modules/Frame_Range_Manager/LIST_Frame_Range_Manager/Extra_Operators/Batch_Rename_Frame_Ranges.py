...
class FR_OT_FRM_Batch_Rename_Frame_Range(bpy.types.Operator):

    bl_idname = "fr_frm.batch_rename_frame_ranges"
    bl_label = "Batch Rename Frame Range"
    bl_description = "Batch Rename Frame Range"
    ...
    def execute(self, context):
        ...
        FRM_Functions.batch_rename_fr(self.mode, self.string_a, self.string_b)
...
classes = [FR_OT_FRM_Batch_Rename_Frame_Range]
